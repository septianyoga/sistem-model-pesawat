        ...
        <div class="row">
            <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                <div class="card flex-fill">
                    ...
                    <form action="/ebom/{{ $ebom->id }}" method="POST">
                        @csrf
                        @method('patch')
                        <div class="card-body">
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" value="{{ $ebom->no_item }}" class="form-control" name="no_item"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" value="{{ $ebom->component }}" class="form-control"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" value="{{ $ebom->item_description }}" class="form-control"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" value="{{ $ebom->quantity }}" class="form-control"
                                    ...
                                    <select name="trpgmmodel" id="select2" class="form-select">
                                        ...
                                        @foreach ($trpgmmodel as $model)
                                            <option value="{{ $model->id }}"
                                                {{ $ebom->trpgmmodel_id == $model->id ? 'selected' : '3' }}>
                        ...
                        <div class="card-footer d-flex justify-content-between ">
                            <a href="/ebom" class="btn btn-link text-decoration-none "><i
