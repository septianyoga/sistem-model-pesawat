            ...
            <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                <div class="card flex-fill">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="/ebom/add" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Add
                                Data
                                EBOM</a>
                                ...
                                @foreach ($eboms as $ebom)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/ebom/{{ $ebom->id }}/edit" class="btn btn-info btn-sm"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Import Data EBOM</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="/ebom/import" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <p>Keterangan: <br> Format kolom Excel harus sama.
                                <a class="text-decoration-none" href="/download_ebom_template">Klik Disini</a>
