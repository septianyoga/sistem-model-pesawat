                            ...
                            <tbody>
                                @foreach ($models as $model)
                                    <tr>
                                        ...
                                        {{-- <td>{{ $model->c_pgm }}</td>
                                        <td>{{ $model->c_pgm_sub }}</td>
                                        <td>{{ $model->c_pgm_ver }}</td> --}}
                                        ...
                                        <td class="text-center">
                                            <a onclick="handleDelete({{ $model->id_c_pgm_pon }})"
                                                class="btn btn-danger btn-sm"><i data-confirm-delete="true"
                                                    class="fa-solid fa-trash"></i></a>
                                            <button id="btn-{{ $model->id_c_pgm_pon }}" class="btn btn-info btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#edit-{{ $model->id_c_pgm_pon }}"><i
